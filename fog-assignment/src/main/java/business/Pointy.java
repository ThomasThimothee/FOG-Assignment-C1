...
public class Pointy extends Carport {
    ...
    public Partlist createPartList() {
        ...
        qWoodA = 2;
        lengthWoodA = 480;
        woodA = new Wood(Part.PartType.WOOD, qWoodA, lengthWoodA, "25x150 mm. trykimp. bræt", "vindskeder på rejsning");
        ...
        woodB = new Wood(Part.PartType.WOOD, qWoodB, lengthWoodB, "25x150 mm. trykimp. bræt", "Sternbrædder til siderne carport del");
        ...
        woodC = new Wood(Part.PartType.WOOD, qWoodC, lengthWoodC, "25x150 mm. trykimp. bræt", "Sternbrædder til siderne skur del");
        super.partList.getPartList().add(woodC);

        // D
        qWoodD = 1;
        lengthWoodD = 0;
        woodD = new Wood(Part.PartType.WOOD, qWoodD, lengthWoodD, "fædigskåret", "byg-selv spær (skal samles) 8 stk");
        ...
        woodF = new Wood(Part.PartType.WOOD, qWoodF, lengthWoodF, "45x195 mm. ubh. spærtræ", "remme i sider, sadles ned i stolper");
        ...
        woodG = new Wood(Part.PartType.WOOD, qWoodG, lengthWoodG, "45x195 mm. ubh. spærtræ", "remme i sider, sadles ned i stolper (skur del, deles)");
        ...
        woodH = new Wood(Part.PartType.WOOD, qWoodH, lengthWoodH, "45x95 mm. ubh. reglar", "løsholter i siderne af skur");
        ...
        woodI = new Wood(Part.PartType.WOOD, qWoodI, lengthWoodI, "45.95 mm. ubh. reglar", "løsholter i gavle af skur");
        super.partList.getPartList().add(woodI);

        // J
        qWoodJ = 2;
        lengthWoodJ = woodA.getLength();
        woodJ = new Wood(Part.PartType.WOOD, qWoodJ, lengthWoodJ, "19x100 mm. trykimp. bræt", "Vand bræt på vindskeder");
        super.partList.getPartList().add(woodJ);

        // K
        qWoodK = (int) ((carportWidth * 2 * 10 - 100) / 73 / 3);
        lengthWoodK = 240;
        woodK = new Wood(Part.PartType.WOOD, qWoodK, lengthWoodK, "19x100 mm. trykimp. bræt", "til beklædning af gavle 1 på 2");
        super.partList.getPartList().add(woodK);

        // L
        qWoodL = (int) (((shedLength * 2 + shedWidth * 2) * 10 - 100) / 73);
        lengthWoodK = 210;
        woodL = new Wood(Part.PartType.WOOD, qWoodL, lengthWoodK, "19x100 mm. trykimp. bræt", "til beklædning af skur 1 på 2");
        ...
        woodM = new Wood(Part.PartType.WOOD, qWoodM, lengthWoodM, "25x50 mm. trykimp. bræt", "til montering oven på tagfodslægte");
        super.partList.getPartList().add(woodM);

        // N
        qWoodN = 1;
        lengthWoodN = 540;
        woodN = new Wood(Part.PartType.WOOD, qWoodN, lengthWoodN, "38x73 mm. taglægte T1", "til z på bagside af dør");
        super.partList.getPartList().add(woodN);

        // O
        qWoodO = 21;
        lengthWoodO = 540;
        woodO = new Wood(Part.PartType.WOOD, qWoodO, lengthWoodO, "38x73 mm. taglægte T1", "til montering på spær, 7 rækker lægter på hver skiftevis 1 hel & 1 halv lægte");
        ...
        woodP = new Wood(Part.PartType.WOOD, qWoodP, lengthWoodP, "38x73 mm. taglægte T1", "toplægte");
        super.partList.getPartList().add(woodP);

        // Tagpakken
        // A
        qTileA = 300;
        tileA = new Tile(Part.PartType.TILE, qTileA, "stk.", 0, "B&C Dobbelt -s sort", "monteres på taglægter 6 rækker af 24 sten på hver side af taget");
        super.partList.getPartList().add(tileA);

        // B
        qTileB = 21;
        tileB = new Tile(Part.PartType.TILE, qTileB, "stk.",  0, "B&C Rygsten sort", "monteres på toplægte med medfølgende beslag. Se tagsten vejledning");
        super.partList.getPartList().add(tileB);

        // C
        qTileC = 8;
        tileC = new Tile(Part.PartType.TILE, qTileC, "stk.",  0, "B&C Toplægte holder", "monteres på toppen af spæret (til toplægte)");
        ...
        // E
        qTileE = 2;
        tileE = new Tile(Part.PartType.TILE, qTileE, "pakke",  0, "B&C Tagstensbindere & nakkekroge", "til montering af tagsten, alle ydersten + hver anden fastgøres");
        super.partList.getPartList().add(tileE);

        // Beslag & Skruer        
        // A
        qScrewA = 8;
        screwA = new Screw(Part.PartType.SCREW, qScrewA, "stk.", 190, "universal højre", "til montering af spær på rem");
        super.partList.getPartList().add(screwA);

        // B
        qScrewB = 8;
        screwB = new Screw(Part.PartType.SCREW, qScrewB, "stk.", 190, "universal venstre", "til montering af spær på rem");
        super.partList.getPartList().add(screwB);

        // C
        qScrewC = 1;
        screwC = new Screw(Part.PartType.SCREW, qScrewC, "sæt", 0, "50x75 mm. stalddørsgreb", "til lås på dør i skur");
        super.partList.getPartList().add(screwC);

        // D
        qScrewD = 2;
        screwD = new Screw(Part.PartType.SCREW, qScrewD, "stk.", 390, "t-hængsel", "til dør i skur");
        super.partList.getPartList().add(screwD);

        // E
        qScrewE = 20;
        screwE = new Screw(Part.PartType.SCREW, qScrewE, "stk.", 35, "vinkelbeslag", "til montering af løsholter i skur");
        super.partList.getPartList().add(screwE);

        // F
        qScrewF = 1;
        screwF = new Screw(Part.PartType.SCREW, qScrewF, "pakke", 0, "4,5x60 mm. skruer 200 stk.", "til montering af stern, vindskeder, vindkryds & vandbræt");
        super.partList.getPartList().add(screwF);

        // G
        qScrewG = 1;
        screwG = new Screw(Part.PartType.SCREW, qScrewG, "pakke", 0, "5x40 mm. beslagskruer 250 stk.", "til montering af universalbeslag & toplægte");
        super.partList.getPartList().add(screwG);

        // H
        qScrewH = 2;
        screwH = new Screw(Part.PartType.SCREW, qScrewH, "pakke", 0, "5x100 mm. skruer 100 stk.", "til taglægter");
        super.partList.getPartList().add(screwH);

        // I
        qScrewI = 20;
        screwI = new Screw(Part.PartType.SCREW, qScrewI, "stk.", 0, "10x120 mm. bræddebolt", "til montering af rem på stolper");
        super.partList.getPartList().add(screwI);

        // J  
        qScrewJ = 20;
        screwJ = new Screw(Part.PartType.SCREW, qScrewJ, "stk.", 11, "40x40 mm. firkantskiver", "til montering af rem på stolper");
        super.partList.getPartList().add(screwJ);

        // K
        qScrewK = 3;
        screwK = new Screw(Part.PartType.SCREW, qScrewK, "pakke", 0, "4,5x70 mm. skruer 200 stk.", "til montering af yderste bræt ved beklædning");
        super.partList.getPartList().add(screwK);

        // L
        qScrewL = 2;
        screwL = new Screw(Part.PartType.SCREW, qScrewL, "pakke", 0, "4,5x50 mm. skruer 350 stk.", "til montering af inderste bræt ved beklædning");
